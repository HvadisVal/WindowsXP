<template>
  ...
  import startupSoundFile from '../assets/windowsXPStartup.wav';
  ...
  export default {
    ...
    methods: {
      startComputer() {
        ...
        loader.load('/src/assets/windows_7_is_starting.glb', (gltf) => {
      ...
      initThree() {
        ...
        const loader = new GLTFLoader();
        loader.load('/src/assets/old_computer.glb', (gltf) => {
